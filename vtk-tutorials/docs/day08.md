...
if (NOT __VTK_INCLUDED)
	...
	if (NOT VTK_FOUND)
		set(VTK_URL "http://10.0.1.66:4000/devtools/src/VTK-8.2.0.tar.gz")
		...
		ExternalProject_Add(${VTK_DirName}
				...
				#----------vtk8------------
				CMAKE_ARGS -DVTK_USE_X:BOOL=FALSE
				CMAKE_ARGS -DVTK_OPENGL_HAS_OSMESA:BOOL=TRUE
 				CMAKE_ARGS -DVTK_DEFAULT_RENDER_WINDOW_OFFSCREEN:BOOL=TRUE
				#----------vtk8------------
